      ...
      <div className="container mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center pt-20 lg:pt-0">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
            ...
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-500">REDDY G</span>
          </h1>
          ...
          <p className="text-muted-foreground max-w-lg text-lg leading-relaxed">
            2nd-year B.Tech CS (Data Science) at VNR VJIET, Hyderabad. 
            Building full-stack apps with React + Node.js. 
            Crushing LeetCode, CodeForces, HackerRank daily.
          </p>
          ...
          >
            <motion.a
              href="#contact"
              whileHover={{ scale: 1.05, boxShadow: "0 0 30px hsl(258 90% 66% / 0.5)" }}
              whileTap={{ scale: 0.95 }}
